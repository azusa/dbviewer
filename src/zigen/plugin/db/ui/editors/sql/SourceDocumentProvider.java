...
//        }
        ...
        /*
        ICompilableDBO dbo = JoraPlSqlEditor.findAndRefreshDocumentsDBO(cn, document);
        if(dbo != null)
        {
            input.setDBO(dbo);
            String msg = MCompileError.toMessage(dbo.getCompileErrors());
            if(msg != null)
                throw new CoreException(new Status(4, "de.tl.jora", 0, msg, null));
        }*/
    }
