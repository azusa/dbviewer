...
public class ColumnCompletionProposal implements ICompletionProposal {
	 ...
	 */
	public ColumnCompletionProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition, Image image, String displayString, IContextInformation contextInformation, String additionalProposalInfo) {
