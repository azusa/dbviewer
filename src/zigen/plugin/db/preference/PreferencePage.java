...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public static final String P_CHANGE_NULL_COLOR = "PreferencePage.ChangeNullColor"; // NULLï∂éöÇÃêFÇïœçXÇ∑ÇÈÇ© //$NON-NLS-1$

	public static final String P_MAX_HISTORY = "PreferencePage.MaxHistory"; // SQLé¿çsóöóÇÃï€ë∂êî //$NON-NLS-1$

	public static final String P_COLOR_BACKGROUND = "PreferencePage.BackGround"; // ñæç◊ÇÃîwåiêF //$NON-NLS-1$
